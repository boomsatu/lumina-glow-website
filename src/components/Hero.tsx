...
const Hero = () => {
  ...
  return (
    <div className="hero-pattern pt-28 pb-20 md:pt-32 md:pb-24 relative">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col md:flex-row items-center">
          <div className="flex-1 text-center md:text-left mb-10 md:mb-0 max-w-2xl relative">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 bg-gradient-to-r from-white to-blue-200 bg-clip-text text-transparent animate-fade-in">
              {t('hero', 'title')}
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              ...
              <Button variant="outline" className="border-lumina-500 text-white hover:bg-lumina-800/50 text-lg px-6 py-6 h-auto glass-effect transition-all duration-300 hover:scale-105">
            ...
            <div className="mt-8 flex flex-wrap justify-center md:justify-start gap-6">
              <div className="flex items-center glass-effect px-4 py-2 rounded-full">
                ...
                <span className="text-white/70">{t('hero', 'presaleLive')}</span>
              </div>
              <div className="flex items-center glass-effect px-4 py-2 rounded-full">
                <div className="font-medium text-white/90">100B</div>
                <span className="text-white/70 ml-2">{t('hero', 'totalSupply')}</span>
              </div>
              <div className="flex items-center glass-effect px-4 py-2 rounded-full">
                <div className="font-medium text-white/90">24,352</div>
                <span className="text-white/70 ml-2">{t('hero', 'holders')}</span>
              </div>
            </div>
          </div>
